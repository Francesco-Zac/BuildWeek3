...
const Navbar = () => {
  ...
  <div>
    ...
    <p className="mb-0 small">Lavoro</p>
          ...
          <div className="dropdown text-center d-flex flex-column align-items-center">
            <button
              ...
              style={{
                width: "24px",
                height: "24px",
                backgroundImage: mainUser?.image ? `url(${mainUser.image})` : "none",
            ...
            <ul className="dropdown-menu dropdown-menu-end mt-2 p-3" aria-labelledby="meDropdown" style={{ width: "280px" }}>
              <li className="d-flex align-items-start mb-3">
                ...
                <div>
                  <strong>
                    {mainUser?.name || "Utente"} {mainUser?.surname || ""}
                  </strong>
                  <br />
                  <small className="text-muted">{mainUser?.title || "Ruolo non disponibile"}</small>
                  <div className="mt-2 row">
                    <a href="/profile" className="btn btn-outline-primary btn-sm me-2">
                      Visualizza profilo
                    </a>
              ...
              <li>
                <a className="dropdown-item" href="/premium">
              ...
              <li>
                <a className="dropdown-item" href="/job-offers">
          ...
          <div className="dropdown ">
            ...
            {/* Menu */}
            <div className="dropdown-menu p-4 shadow-lg" aria-labelledby="businessDropdown" style={{ minWidth: "650px", maxWidth: "1000px" }}>
              <div className="row">
  ...
  ⚠️ Attenzione: schermo troppo piccolo!
</div>
    </nav>

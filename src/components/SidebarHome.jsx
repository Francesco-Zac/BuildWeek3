      ...
      <div className="sidebar-home">
            ...
            {newsItems.map((item, index) => (
              <li key={index} className="mb-2">
                ...
                <small className="text-muted">
                  {item.time} · {item.readers} lettori
                </small>
              </li>
            ))}
          </ul>
          <button className="btn btn-link p-0" style={{ fontSize: "14px", textDecoration: "none", color: "black" }}>
            Mostra altro <i className="bi bi-caret-right"></i>
          </button>
          <hr />
          <div className="mt-3">
            <p className="mb-1 d-flex" style={{ fontWeight: "bold" }}>
            ...
            <div className="d-flex align-items-center justify-content-between p-2 rounded border">
              ...
              <div>
                <small>Zip – un rompicapo veloce</small>
                <br />
        ...
        <div className="sticky-sidebar">
          ...
          <div className="p-2 d-flex gap-2 bg-white rounded">
            <span className="badge bg-warning text-dark mb-2">SUGGERIMENTO</span>
            <br />
          ...
          <div style={{ fontSize: "12px", color: "#666" }}>
            ...
            <div className="d-flex justify-content-center gap-2 mt-2">
              <svg display="var(--hue-web-svg-display-light)" width="56" height="14" xmlns="http://www.w3.org/2000/svg">
                <image href="https://static.licdn.com/aero-v1/sc/h/aahlc8ivbnmk0t3eyz8as5gvr" x="0" y="0" width="56" height="14" />
              </svg>

...
const LinkedinJobsPage = () => {
  ...
  // Caricamento API
  useEffect(() => {
    fetch("https://strive-benchmark.herokuapp.com/api/jobs?limit=5")
      .then((res) => res.json())
      .then((data) => {
        setJobs(data.data);
        setLoading(false);
      })
      .catch((err) => console.error("Errore nel caricamento lavori", err));
  }, []);
      ...
      <div className="card bg-light mb-4">
        <div className="card-body d-flex align-items-center">
          ...
          <div className="flex-grow-1">
            <p className="mb-1"><strong>Fatti notare dai recruiter</strong> con offerte di lavoro personalizzate per te</p>
